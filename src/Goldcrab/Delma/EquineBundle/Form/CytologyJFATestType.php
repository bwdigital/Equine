...
class CytologyJFATestType extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Goldcrab\Delma\EquineBundle\Entity\CytologyJFATest'
        ));
    }
    ...
    {
        return 'goldcrab_delma_equinebundle_cytologyjfatesttype';
    }
}
