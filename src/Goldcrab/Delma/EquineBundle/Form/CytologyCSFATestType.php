...
class CytologyCSFATestType extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Goldcrab\Delma\EquineBundle\Entity\CytologyCSFATest'
        ));
    }
    ...
    {
        return 'goldcrab_delma_equinebundle_cytologycsfatesttype';
    }
}
