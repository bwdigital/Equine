...
class CytologyGeneralTestType extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Goldcrab\Delma\EquineBundle\Entity\CytologyGeneralTest'
        ));
    }
    ...
    {
        return 'goldcrab_delma_equinebundle_cytologygeneraltesttype';
    }
}
