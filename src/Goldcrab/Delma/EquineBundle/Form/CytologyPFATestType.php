...
class CytologyPFATestType extends AbstractType
{
    /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Goldcrab\Delma\EquineBundle\Entity\CytologyPFATest'
        ));
    }
    ...
    {
        return 'goldcrab_delma_equinebundle_cytologypfatesttype';
    }
}
